...
Rules that apply specifically to C# API projects.
...
- Strongly typed configuration bound from environment-aware settings.
- Dependency injection through explicit composition roots.
- Integration tests for auth, repositories, health, storage, and critical endpoint flows.

## Forbidden Patterns

- Scattering service registration and HTTP pipeline configuration across the codebase.
- Mixing business logic into transport handlers because framework hooks make it convenient.
